        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimarySpecialtyId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "DoctorCustomizations",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DoctorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LogoStoragePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PrimaryColorHex = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: true),
                    SecondaryColorHex = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: true),
                    ...
                    ClinicDisplayName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InvoicePrefix = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ExtraSettingsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorCustomizations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorCustomizations_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicSettings_DoctorId_Key",
                table: "ClinicSettings",
                columns: new[] { "DoctorId", "Key" },
                unique: true,
                filter: "[DoctorId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorCustomizations_DoctorId",
                table: "DoctorCustomizations",
                column: "DoctorId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorDocuments_ExpiryDate",
                table: "DoctorDocuments",
                column: "ExpiryDate");
